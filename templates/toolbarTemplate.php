...
<script id="toolbarTemplate" type="text/x-handlebars-template">
    <div class="toggleSeriesPanel">
        <div id="toggleSeriesPanelButton" tabindex="1" class="toolbarSectionButton roundedButton toggleSeriesPanelButton <?php if($seriesPanelOpen === 'true') echo 'active'; ?> {{classes}}" title="Toggle Series Panel">
