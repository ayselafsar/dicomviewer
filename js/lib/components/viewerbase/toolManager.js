...
export const toolManager = {
    init() {
        ...
        if (DCMViewerManager.defaultTool) {
            this.setDefaultTool(DCMViewerManager.defaultTool);
        }

        defaultMouseButtonTools = DCMViewerManager.settings && DCMViewerManager.settings.public && DCMViewerManager.settings.public.defaultMouseButtonTools;
    ...
    configureTools() {
        ...
        if (DCMViewerManager.settings && DCMViewerManager.settings.public && DCMViewerManager.settings.public.defaultGestures) {
            gestures.zoomTouchPinch = DCMViewerManager.settings.public.defaultGestures.zoomTouchPinch || gestures.zoomTouchPinch;
            gestures.stackScrollMultiTouch = DCMViewerManager.settings.public.defaultGestures.stackScrollMultiTouch || gestures.stackScrollMultiTouch;
            gestures.panMultiTouch = DCMViewerManager.settings.public.defaultGestures.panMultiTouch || gestures.panMultiTouch;
            gestures.doubleTapZoom = DCMViewerManager.settings.public.defaultGestures.doubleTapZoom || gestures.doubleTapZoom;
        }
    ...
    configureLoadProcess() {
        ...
        function handleLoadProgress (e) {
            ...
            const encodedId = Utils.string.encodeId(eventData.imageId);
            DCMViewerManager.sessions[`CornerstoneThumbnailLoadProgress${encodedId}`] = eventData.percentComplete;
        }
