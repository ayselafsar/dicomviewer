...
export class BaseInstanceMetadata extends Metadata {
    ...
    getStringValue(tagOrProperty, index, defaultValue) {
        ...
        return BaseInstanceMetadata.getIndexedValue(value, index, defaultValue);
    }
     ...
     * @param {BaseInstanceMetadata} instance An instance of the InstanceMetadata class.
    ...
    equals(instance) {
        ...
        return (
            instance === self ||
            (
                instance instanceof BaseInstanceMetadata &&
