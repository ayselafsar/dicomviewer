OC.L10N.register(
    ...
    "Capture High Quality Image" : "Catura imàgine de calidade arta",
    "Please specify the dimensions, and desired type for the output image." : "Ispetzìfica is mannàrias e sa genia imàgine produida chi boles.",
    "Width (px)" : "Largària (px)",
    "Height (px)" : "Altura (px)",
    "File Name" : "Nùmene de s'archìviu",
    "File Type" : "Genia de s'archìviu",
    "Show Annotations" : "Mustra notas",
    "Image Quality (%)" : "Calidade de s'imàgine (%)",
